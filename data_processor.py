...
class DataProcessor(object):
    ...
    # 将提取的abs和label分别保存为data.input和data.output。
    ...
    # 将上一步得到的data.input/output分割为三个数据集，保存为train.input/output，val.input/output，test.input/output
    ...
    def split_data(self, data_name='aapr', split_rate=0.7):
        ...
        train_output_path = data_folder + 'train.output'
        ...
        # 保存验证数据。
        val_input_path = data_folder + 'val.input'
        val_output_path = data_folder + 'val.output'
        ...
        # 保存测试数据。
        test_input_path = data_folder + '/test.input'
        test_output_path = data_folder + '/test.output'
